...
CREATE TABLE "User" (
    ...
    "email" TEXT NOT NULL,
    "avatar" TEXT NOT NULL DEFAULT 'https://reedbarger.nyc3.digitaloceanspaces.com/default-avatar.png',
    "cover" TEXT NOT NULL DEFAULT 'https://reedbarger.nyc3.digitaloceanspaces.com/default-cover-banner.png',
